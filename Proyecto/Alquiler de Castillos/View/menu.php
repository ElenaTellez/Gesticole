        ...
        <div class="container">
            <div id="cambio" title="Abrir menu" class="dropdown">  
                        <div id="personal" class="jumbotron dropdown-content"> 
                            <a href="../../Administracion/Teacher/index.php" title="Ir a la sección de Profesores">Profesores</a><hr>
                            <a href="../../Alumno/index.php" title="Ir a la sección de Alumnos">Alumnos</a><hr>
                            <a href="../index.php" title="Volver al inicio">Inicio</a><hr>
                            <a href="../../index.php" title="Salir del Sistema">Salir</a><hr>
                        </div>
            </div> 
            <div id="anadir" class="dropdown" style="margin-left: 30px;">  
                        <div id="personal" class="jumbotron dropdown-content" width="75" height="75">
                            <a href="#" id="nuevoDos"  title="Añadir un nuevo Castillo a la Base de dAtos">
                                    <img src="data:image/gif;base64,/9j/4AAQSkZJRgABAgAAZABkAAD/7AARRHVja3kAAQAEAAAANAAA/+4ADkFkb2JlAGTAAAAAAf/b
                                         ...
                                         UCgUCgUCgUCgUCg//9k=" width="75" height="75" class="img-responsive" alt="Castillo" title="Añadir un nuevo Castillo">
                                 </a>   
                        </div>
            </div> 

            
            <div id="menu_visible" class="col-xs-6 col-md-3">
                <div id="personal" class="jumbotron">
                 <a  href="#" id="nuevo" title="Añadir un nuevo Castillo a la Base de dAtos">
                                    <img src="data:image/gif;base64,
                                         ...
                                         7q/UEc5+I58fw0k8P7NQTr0t2rkdp7Fx238ktpybCMjtVsKUps9rIdeTpUtLaj5Lg5poNooMW43o
                                         M0CgUCgUCgUCgUCgUCgUCgUCgUCgUCgUCgUCgUCgUCgUCgUCgUCgUCgUCgUCgUCgUCgUCgUCgUCg
                                         UCgUCgUCgUCgUCg//9k=" width="75" height="75" class="img-responsive" alt="Castillo">
                                <h5 class="texto text-center">Añadir Castillo</h5></a>   
                </div>  
            </div> 
                 ...
                 <div id="personal" class="jumbotron">
                        <div class="row placeholders">
                            <div class="col-xs-6 col-sm-3 placeholder">
                                <a href="../../Administracion/Teacher/index.php">
                                    <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAIAAAACACAYAAADDPmHLAAAABHNCSVQICAgIfAhkiAAAAAlwSFlz
                                         ...
                                         YF2Sv7mK+OBLl6TY/wMNvVYjAY/5WQAAAABJRU5ErkJggg==" width="100" height="100" class="img-responsive" title="ir a la seccion Profesores">
                                </a> 
                            </div>

                            <div class="col-xs-6 col-sm-3">
                                <a href="../../Administracion/Alumno/index.php" title="Ir a la sección de Alumnos">
                                    <img src="data:image/png;base64,/9j/4AAQSkZJRgABAQAAAQABAAD//gA7Q1JFQVRPUjogZ2QtanBlZyB2MS4wICh1c2luZyBJSkcg
                                         ...
                                         FFABRRRQB+s//BDn/kWfi7/1+aZ/6Bc1+oNfl9/wQ5/5Fn4u/wDX5pn/AKBc1+oNAH//2Q==" width="100" height="100" class="img-responsive" alt="Alumnos">
                                </a> 
                            </div>
                            <div class="col-xs-6 col-sm-3" title="Volver al menú de Inicio">
                                <a href="../../Administracion/index.php">
                                    <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAIAAAACACAYAAADDPmHLAAAABHNCSVQICAgIfAhkiAAAAAlwSFlz
                                         ...
                                         mACJE3q08LOBdYHnGYpngRdrTrsa2BCwlpD8Y/FjGIZhGD78FwzPNGqDDF/CAAAAAElFTkSuQmCC" width="100" height="100" class="img-responsive" alt="Inicio">
                                </a> 
                            </div>
                            <div class="col-xs-6 col-sm-3">
                                <a href="../../index.php" title="Salir del Sistema">
                                    <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAIAAAACACAMAAAD04JH5AAAAA3NCSVQICAjb4U/gAAAACXBIWXMA
                                         ...
                                         RK5CYII=" width="100" height="100"class="img-responsive" alt="Salir">
                                </a> 
                            </div>
                        </div>          
        <?php
