                    ...
                    <div id="personal" class="jumbotron">
                        <div class="row placeholders">
                            <div class="col-xs-6 col-sm-3">
                                <a  href="../../Alquiler de Castillos/index.php" title="Ir a la sección de Castillos Hinchables">
                            ...
                            <div class="col-xs-6 col-sm-3">
                                <a href="../Teacher/index.php" title="Ir a la sección de Profesores">
                           ...
                           <div class="col-xs-6 col-sm-3" title="Volver al menú de Inicio">
                                <a href="../index.php">
                                    <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAIAAAACACAYAAADDPmHLAAAABHNCSVQICAgIfAhkiAAAAAlwSFlz
                                         ...
                                         mACJE3q08LOBdYHnGYpngRdrTrsa2BCwlpD8Y/FjGIZhGD78FwzPNGqDDF/CAAAAAElFTkSuQmCC" width="150" height="150" class="img-responsive" alt="Inicio">
                                </a> 
                            </div>
                            <div class="col-xs-6 col-sm-3">
